...
const downloads = [
  ...
  {
    title: 'Förderkriterien Projektförderung',
  ...
  {
    title: 'Antragsformular Auslandsaufenthalt',
    description: 'Formular für den Antrag auf Zuschuss.',
    type: 'PDF',
    href: '/downloads/Vorlage 1_Antragsformular.pdf',
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
        <polyline points="14 2 14 8 20 8"/>
  ...
  {
    title: 'Kurzgutachten Auslandsaufenthalt',
    description: 'Bewertungsbogen durch eine Professorin/einen Professor.',
    type: 'PDF',
    href: '/downloads/Vorlage 2_Kurzgutachten.pdf',
    icon: (
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
        <polyline points="14 2 14 8 20 8"/>
      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Satzung, Förderkriterien und Antragsunterlagen – alles auf einen Blick.
          </p>
        </div>
